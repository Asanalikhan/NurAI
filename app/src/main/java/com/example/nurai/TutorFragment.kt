...
import com.example.nurai.databinding.FragmentTutorBinding

class TutorFragment : Fragment() {
    private lateinit var _binding: FragmentTutorBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.bottomNav.ivHome.setOnClickListener {
            findNavController().navigate(R.id.action_tutorFragment_to_homeFragment)
        }
        binding.bottomNav.ivHealth.setOnClickListener {
            findNavController().navigate(R.id.action_tutorFragment_to_healthFragment)
        }
        binding.bottomNav.ivPsychology.setOnClickListener {
            findNavController().navigate(R.id.action_tutorFragment_to_psychologyFragment)
        }
    }
    ...
    private fun initUI() {
        ...
        binding.bottomNav.tvTutor.setTextColor(ContextCompat.getColor(requireContext(), R.color.primary_blue))
        ...
        binding.bottomNav.ivTutor.setImageResource(R.drawable.ic_tutor_clicked)
    }
